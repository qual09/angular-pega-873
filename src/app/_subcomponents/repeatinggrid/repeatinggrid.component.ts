    ...
    if (sRefType == "List") {
      ...
      while(!bGotValidIndex){
        ...
        // Checking row name validity (Unique alphanumeric values starting with an alphabet are allowed)
          ...
          bGotValidIndex = !this.layoutComp.rows.find( row => row.groupIndex === groupRowRef );
        }      
      }
      ...
      if (this.layoutComp.referenceType === "List") {
        ...
        while(!bGotValidIndex){
          ...
          // Checking row name validity (Unique alphanumeric values starting with an alphabet are allowed)
            ...
            bGotValidIndex = !this.layoutComp.rows.find( row => row.groupIndex === rowName );
          }      
        }
  ...
  removeRow() {
    ...
    if (sRowEditing != "readOnly") {
      ...
      if (this.layoutComp.referenceType === "List") {
        ...
        // group
        let bGotValidIndex: boolean = false;
        let rowName = "";
